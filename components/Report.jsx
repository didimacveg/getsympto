...
const SEVERITY_CONFIG = {
  bajo: { color: 'bg-green-100 text-green-700 border-green-200', icon: '🟢', label: 'Nivel bajo' },
  medio: { color: 'bg-yellow-100 text-yellow-700 border-yellow-200', icon: '🟡', label: 'Nivel medio' },
  alto: { color: 'bg-orange-100 text-orange-700 border-orange-200', icon: '🟠', label: 'Nivel alto' },
  urgente: { color: 'bg-red-100 text-red-700 border-red-200', icon: '🔴', label: 'URGENTE' },
};

const ACTION_LABELS = {
  observar: '🏠 Observar en casa',
  medico_general: '👨‍⚕️ Consultar médico de cabecera',
  especialista: '🏥 Acudir a especialista',
  urgencias: '⚠️ Ir a urgencias',
  emergencia_inmediata: '🚨 Llamar al 112 AHORA',
};
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
      ...
      <div className="p-5 space-y-5">
        ...
        <div className="bg-slate-50 rounded-xl p-4">
          <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Recomendación</h3>
        ...
        {data.red_flags?.length > 0 && (
          <div className="bg-red-50 border border-red-100 rounded-xl p-4">
            <h3 className="text-xs font-semibold text-red-500 uppercase tracking-wide mb-2">
              ⚠️ Consulta urgente si además aparece
            </h3>
        ...
        {data.general_info && (
          <div>
            <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Información general</h3>
        ...
        <div className="border-t pt-4">
          <p className="text-xs text-slate-400 leading-relaxed">{data.disclaimer}</p>
        </div>
