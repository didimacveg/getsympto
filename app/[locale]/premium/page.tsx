...
const CONTENT = {
  es: {
    ...
    premium_features: ['10 análisis por día', 'Reanálisis con seguimiento', 'Descarga de informes en PDF', 'Historial completo', 'IA clínica avanzada'],
  ...
  en: {
    ...
    premium_features: ['10 analyses per day', 'Re-analysis with follow-up', 'PDF report download', 'Full history', 'Advanced clinical AI'],
  ...
  zh: {
    ...
    premium_features: ['每天10次分析', '跟踪重新分析', 'PDF报告下载', '完整历史记录', '高级临床AI'],
    free_cta: '当前计划',
    premium_cta: '升级到高级版',
    login_cta: '登录继续',
    popular: '最受欢迎',
  ...
  ru: {
    ...
    premium_features: ['10 анализов в день', 'Повторный анализ', 'Скачивание PDF', 'Полная история', 'Расширенный клинический ИИ'],
